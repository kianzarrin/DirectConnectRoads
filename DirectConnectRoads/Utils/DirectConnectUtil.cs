 namespace DirectConnectRoads.Utils {
    ...
    using static DirectConnectRoads.Utils.Extensions;
    ...
    public static class DirectConnectUtil {
        ...
        /// <returns></returns>
        internal static bool CanDirectConnect(
            ushort segmentId1,
            ushort segmentId2,
            ushort nodeId,
            int nodeInfoIDX) {
